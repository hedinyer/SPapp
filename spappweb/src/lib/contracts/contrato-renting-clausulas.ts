/**
 * Texto legal verbatim del Contrato de Renting (port de
 * spapp/lib/data/contrato_renting_clausulas.dart). Placeholders comerciales
    ...
    clausulas: [
      {
        ...
        texto:
          "EL CONTRATANTE no podrá ceder ni subarrendar el objeto del presente contrato ni subrogar a persona física o jurídica los derechos emanados de este contrato. De igual manera, le está prohibido a EL CONTRATANTE usar el bien por fuera de los límites del Área Metropolitana de Bucaramanga, so pena de incurrir en incumplimiento del presente contrato.\n\nPARAGRAFO: Pese a lo anterior, EL CONTRATANTE, podrá ceder la opción de compra derivada del presente contrato, siempre que notifique al PROPIETARIO dentro de los 30 días siguientes a la expiración del presente contrato.\n\nPARAGRAFO 2: EL CONTRATANTE, no podrá manipular el GPS de la motocicleta ya que constituye una falta grave y procede a la perdida de los derechos.",
      },
      {
        titulo: "DÉCIMA PRIMERA: RESPONSABILIDAD POR EL USO DEL BIEN",
        texto:
          "EL CONTRATANTE, en virtud a haber recibido del propietario la tenencia, uso, goce, explotación, administración y vigilancia del bien, reconoce y declara que el PROPIETARIO, desprovista materialmente del bien, de su guarda y su custodia, no tiene ninguna responsabilidad civil, contractual, extracontractual, penal, ni de ninguna otra índole o carácter, por daños o perjuicios que con el uso del bien se le cause al mismo CONTRATANTE o a TERCEROS, ya sea en su integridad personal o en sus bienes, ya que el CONTRATANTE asume para sí todos los riegos previsibles o no, que se generan por tener la explotación o uso de los bienes, sin que esto se pueda predicar el PROPIETARIO. Igualmente, EL CONTRATANTE, es responsable hasta la culpa leve ante el PROPIETARIO, por el cuidado, conservación, buen uso y mantenimiento del bien\n\nEn las situaciones en que EL PROPIETARIO, sea demandada a fin de reducir su responsabilidad civil, contractual, extracontractual, penal, o de cualquier otra índole o carácter, EL CONTRATANTE, se obliga a poner todos los medios de defensa al alcance del PROPIETARIO y se compromete a reembolsar en forma inmediata a esta los gastos que la actuación judicial cause, tales como honorarios, costas, agencias en derecho, y en el caso que la sentencia sea adversa a los intereses del PROPIETARIO a reembolsar el monto de la indemnización a que sea condenada al PROPIETARIO.\n\nEn todo caso el PROPIETARIO, podrá y así lo autoriza EL CONTRATANTE, de forma expresa e irrevocable cargar a la operación de renting las sumas que por cualquier concepto y en relación con cualquier tipo de reclamación ya sea judicial o no, el PROPIETARIO deba asumir en defensa de sus intereses. Así mismo, por cada día de retardo en el pago de las sumas adeudadas al PROPIETARIO, por virtud de lo dispuesto en la presente clausula, se causarán a cargo del CONTRATANTE y a favor del PROPIETARIO, intereses a la tasa moratoria máxima fijada por las autoridades competentes a la fecha en que efectivamente se realice el pago, la cual se liquidará sobre el valor de las sumas pendientes de pago con el correspondiente cobro de intereses moratorios por cada día de retardo en el pago.",
      },
      {
        titulo: "DÉCIMA SEGUNDA",
        texto:
          "El simple retardo en las cuotas descritas en la cláusula cuarta del presente contrato o una vez se tenga conocimiento de un uso indebido del objeto del contrato de parte del CONTRATANTE, autoriza irrevocablemente al PROPIETARIO para obtener la restitución del objeto del contrato, bien sea a través de restitución voluntaria de parte del CONTRATANTE, o a través del medio más expedito, una vez obtenida la restitución del bien, el presente contrato quedará resuelto.",
      },
      {
  ...
  },
  {
    ...
    clausulas: [
      ...
      },
      {
        ...
        texto:
          "Para efectos de notificaciones EL PROPIETARIO las recibirá en la dirección electrónica contacto@solucionesgarrido.com o en centro la calle 37 #20-49 Bucaramanga, y EL CONTRATANTE, en la dirección [DIRECCION_NOTIFICACIONES], ciudad de [CIUDAD_CONTRATANTE], departamento de [DEPARTAMENTO_CONTRATANTE]",
      },
      {
        titulo: "VIGÉSIMA",
        texto:
