  ...
  return (
    <div className="flex min-h-screen flex-col bg-white text-black lg:flex-row">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        <AdminMobileNav />
        <main className="min-h-0 flex-1 touch-pan-y overflow-y-auto overscroll-y-contain [-webkit-overflow-scrolling:touch] max-lg:pt-[calc(3.5rem+env(safe-area-inset-top,0px))]">
